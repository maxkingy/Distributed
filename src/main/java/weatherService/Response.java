...
public class Response {
	...
	public Response(String status, String statusCode, String contentLength, String body, String error, Socket socket) {
		this.status = status;
	...
	// Helper method to create headers for the response. Input argument is the
	// content type.
	...
	/*
	 * Helper method to build the error page. Input arguments are the error code,
	 * name and description. Method returns the error page in String form.
	 */
	...
	/*
	 * Method to send HTTP response and HTML page to client via printing through the
	 * socket.
	 */
	public void respond() {
		try {
	...
	/*
	 * Helper method to check if the status code indicates success. Input argument
	 * is the status code, and the method returns a boolean.
	 */
