...
public class WeatherDataEntry {
  ...
  /*
   Simple getters and setters for each weather data variable. Each setter takes an input argument
   corresponding to the variable. Each getter returns the variable.
   */
